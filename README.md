...
A Rust library for talking to [OpenEPaperLink](https://github.com/OpenEPaperLink/OpenEPaperLink) (OEPL) access points. Push images to e-paper tags, subscribe to real-time events via WebSocket, fiddle with AP settings, and generally automate the things the web UI does — but from code, the way it should be.
